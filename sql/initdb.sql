DO $$
BEGIN
    CREATE ROLE contactdb_owner NOLOGIN NOSUPERUSER NOINHERIT NOCREATEDB CREATEROLE;
...
DO $$
BEGIN
    CREATE ROLE contactdb_ro NOLOGIN NOSUPERUSER NOINHERIT NOCREATEDB CREATEROLE;
EXCEPTION WHEN duplicate_object THEN NULL;
END;
$$;
...
DO $$
BEGIN
    CREATE ROLE contactdb_rw NOLOGIN NOSUPERUSER NOINHERIT NOCREATEDB CREATEROLE;
EXCEPTION WHEN duplicate_object THEN NULL;
END;
$$;
